...
export function SidebarPrimary() {
  ...
  return (
    <div className="flex flex-col items-center justify-center shrink-0 py-2.5 m-2.5 gap-5 w-16 lg:w-(--sidebar-collapsed-width) bg-primary rounded-2xl">
      ...
      <div className="flex flex-col items-center gap-1 shrink-0">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="cursor-pointer my-4">
